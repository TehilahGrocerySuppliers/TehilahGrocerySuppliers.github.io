  ...
  '$routeProvider', function ( $routeProvider ) {
		...
		$routeProvider
		  ...
		  /** FORUM MODULE **/
			.when (
				'/zimbabwe', {
					templateUrl: 'scripts/modules/zimbabwe/zimbabwe-view.html',
					controller: 'ZimbabweController'
				}
			)
			...
			.when (
				'/premiership', {
					templateUrl: 'scripts/modules/premiership/premiership-view.html',
					controller: 'PremiershipController'
				}
			)
			...
			.when (
				'/world', {
					templateUrl: 'scripts/modules/world/world-view.html',
